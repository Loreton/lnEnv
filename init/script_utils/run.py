...
LIB_SRC      = resolvePath(BASE_DIR / "pyLnLib")
MODULES_DIR  = resolvePath(BASE_DIR / "modules")
CORE_DIR     = resolvePath(BASE_DIR / "core")
SOURCE_DIR   = resolvePath(BASE_DIR / "source")
...
def prepare_stage():
    ...
    if MODULES_DIR and MODULES_DIR.exists():
        print(f"copying {MODULES_DIR}")
        shutil.copytree(MODULES_DIR, STAGE_DIR / "modules")

    if CORE_DIR and CORE_DIR.exists():
        print(f"copying {CORE_DIR}")
        shutil.copytree(CORE_DIR, STAGE_DIR / "core")

    if SOURCE_DIR and SOURCE_DIR.exists():
        print(f"copying {SOURCE_DIR}")
        shutil.copytree(SOURCE_DIR, STAGE_DIR / "source")

    if LIB_SRC and LIB_SRC.exists():
        print(f"copying {LIB_SRC}")
