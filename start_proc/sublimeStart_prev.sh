...
#... allora definita manualmente in sudo vi /etc/environment (per renderla globale)
   echo   "calling ${ln_SET_LORETO_ENVIRONMENT}"     >>$myApplicationLog 2>&1
...
# myAppl="/home/loreto/filu/Applications/linuxPortable/SublimeText4_prev/sublime_text"
