...
function @_pennaAdata_16GB() {
    # LABEL="MULTIBOOT" UUID="1AF2-1E6F" BLOCK_SIZE="512" TYPE="vfat" PARTUUID="769286ee-01"
    g_LABEL="MBoot_Adata"
    g_UUID="1AF2-1E6F"
    g_BLOCK_SIZE="512"
    g_fsTYPE="vfat"
    g_PARTUUID="769286ee-01"
    g_MPoint="/media/${USER}/${g_LABEL}"
...
function @_pennaUSB_32GB() {
    # LABEL="102-NOBOOT" UUID="6ABD-70D6" BLOCK_SIZE="512" TYPE="vfat" PARTUUID="a5d64d31-01"
    g_LABEL="102-NOBOOT"
    g_UUID="6ABD-70D6"
    g_BLOCK_SIZE="512"
    g_fsTYPE="vfat"
    g_PARTUUID="a5d64d31-01"
    g_MPoint="/media/${USER}/${g_LABEL}"
