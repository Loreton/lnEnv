...
class ProjectBuilder:
    ...
    def get_content(self, what: str, name: str):
        if what == 'main':
        # 4. Crea __main__.py
...
'''
            ...
            content = f'''# {self.project_name} v{self.version} - Portable Bundle
...
# '''
            ...
            (temp_dir / "__main__.py").write_text(self.get_content(what='main', name=''))
    ...
    def create_bundle(self):
        ...
        try:
            ...
            run_script.write_text(self.get_content(what='script', name=pyz_path.name))
            run_script.chmod(0o755)

            # Versione Windows
            run_bat = temp_dir / "run.bat"
            run_bat.write_text(self.get_content(what='bat', name=pyz_path.name))

            # 5. Crea README
            print("   • Creando README...")
            (temp_dir / "README.txt").write_text(self.get_content(what='readme', name=pyz_path.name))
